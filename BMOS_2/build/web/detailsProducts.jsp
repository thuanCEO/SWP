            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="#">BÀI VIẾT</a></li>
            ...
            <section class="py-5">
                <div class="container px-4 px-lg-5 my-5">
                    <div class="row gx-4 gx-lg-5 align-items-center">
                        <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="${pro.img}" alt="..." /></div>
                        <div class="col-md-6">
                            <h2 class="display-5 fw-bolder" style="color: steelblue">${pro.productName}</h2>
                            <div class="fs-5 mb-5">
                    ...
                    <c:forEach  items="${LIST_PRODUCT}" var="p" begin="0" end="7">
                        <div class="col mb-5">
                            <div class="card h-100">
                                ...
                                <!-- Product image-->
                                <img class="card-img-top" src="${p.img}"  width="100px" height="180px" alt="..." />
                                <!-- Product details-->
